export const UIDataHelperABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IAaveOracle', name: 'oracle', type: 'address' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'pendingLtv', type: 'uint256' },
